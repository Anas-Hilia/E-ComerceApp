			...
			<div class="col product_section clearfix">
				...
				<div class="sidebar">
					<div class="sidebar_section">
						...
						<li><button type="submit" name="search_type" value="all" style="background:none; border:none;" ><a >Tous les categories</a></button></li>
						</form >
								...
								<div class="product-item  <?php echo $donnees['type'];?>">
									<div class="product discount product_filter">
										...
										<div class="product_info">
											<h6 class="product_name"><a href="single.php?product_id=<?php  echo $donnees['id'] ?>"><h4><?php  echo $donnees['libelle'] ?></h4><?php  echo $donnees['description'] ?></a></h6>
